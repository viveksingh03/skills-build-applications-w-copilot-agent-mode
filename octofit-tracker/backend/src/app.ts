...
function buildPayload(resource: string, data: Array<Record<string, unknown>>): ResourcePayload {
  ...
  const resources = [
    {
      ...
      load: async () => {
        ...
        return (await User.find()).map((item) => item.toObject()) as Array<Record<string, unknown>>;
      },
    ...
    },
    {
      ...
      load: async () => {
        await connectToDatabase();
        return (await Team.find()).map((item) => item.toObject()) as Array<Record<string, unknown>>;
      },
      create: async (payload: Record<string, unknown>) => {
        await connectToDatabase();
    ...
    },
    {
      ...
      load: async () => {
        await connectToDatabase();
        return (await Activity.find()).map((item) => item.toObject()) as Array<Record<string, unknown>>;
      },
      create: async (payload: Record<string, unknown>) => {
        await connectToDatabase();
    ...
    },
    {
      ...
      load: async () => {
        await connectToDatabase();
        return (await LeaderboardEntry.find()).map((item) => item.toObject()) as Array<Record<string, unknown>>;
      },
      create: async (payload: Record<string, unknown>) => {
        await connectToDatabase();
    ...
    },
    {
      ...
      load: async () => {
        await connectToDatabase();
        return (await Workout.find()).map((item) => item.toObject()) as Array<Record<string, unknown>>;
      },
      create: async (payload: Record<string, unknown>) => {
        await connectToDatabase();
